  ...
  const   submit = async (e) =>
     {
        ...
        console.log(Id);
        fetch("https://localhost:5001/Selidba/DodatiRecenzijuIOcenuSelidba/"+Id+"/" +recenzija + "/" + currentValue,
        {
        method:"PUT",
   ...
   if(redirect){ 
    return <Navigate to = {"/zavrseneSelidbe"}/>
        ...
        <div style={styles.container}>
            <h2> Ostavite recenziju za selidbu</h2>
...
}export default RecenzijeSelidba